...
####### ########################################### #######
####### THIS SCRIPT IS FOR NVIDIA-JETPACK 4.5.1-b17 #######
#######            RUN THIS WITH SUDO SU            #######
####### ########################################### #######

path1='export PATH="/usr/local/cuda-10.2/bin${PATH:+:${PATH}}"'
path2='export LD_LIBRARY_PATH="/usr/local/cuda-10.2/lib64${LD_LIBRARY_PATH:+:${LD_LIBRARY_PATH}}"'
path3='export LD_PRELOAD="/usr/lib/aarch64-linux-gnu/libgomp.so.1"'
path4='export BUILD_VERSION=0.9.0'
path5='export LD_PRELOAD={$LD_PRELOAD}:"/usr/local/lib/python3.6/dist-packages/scikit_learn.libs/libgomp-d22c30c5.so.1.0.0"'
